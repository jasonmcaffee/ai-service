...
export class CalculatorTools implements AiFunctionExecutor<CalculatorTools>{
  ...
  static getAiExponentiationMetadata(): ChatCompletionTool {
    return {
      type: "function",
      function: {
  ...
  // Modulo Function
  static getAiModuloMetadata(): ChatCompletionTool {
    return {
      type: "function",
      function: {
        name: "aiModulo",
  ...
  static getAiSquareRootMetadata(): ChatCompletionTool {
    return {
      type: "function",
      function: {
        name: "aiSquareRoot",
...
// Factorial Function
  static getAiFactorialMetadata(): ChatCompletionTool {
    return {
      type: "function",
      function: {
        name: "aiFactorial",
  ...
  getToolsMetadata(): ChatCompletionTool[] {
    return [
      ...
      CalculatorTools.getAiExponentiationMetadata(),
      CalculatorTools.getAiFactorialMetadata(),
      CalculatorTools.getAiSquareRootMetadata(),
      CalculatorTools.getAiModuloMetadata(),
    ];
  }
