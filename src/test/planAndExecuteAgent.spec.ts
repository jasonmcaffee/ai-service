...
describe('Plan and Execute agent', () => {
  ...
  it('should create and execute a plan', async ()=> {
    ...
    expect(result9).toBe(18); // sqrt(144) = 12 and 3! = 6, so 12 + 6 = 18
